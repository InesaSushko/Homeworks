 ...
 *
 * */
//1. Разделить строку на массив по словам
//2. Перебирать каждое слово
...
//1. Разбить предложение на массив по словам, создаьб объект
//2. Перебрать каждый элемент массива
//3. Проверить, есть ли свойство в obj с таким именем
//4. Если нет, создаем и значение = 1
